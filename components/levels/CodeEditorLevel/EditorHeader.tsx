            ...
            <div className="ml-auto flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 px-3 py-1 rounded bg-(--bg-surface) border border-(--bg-hover)">
                    <div className={`w-1.5 h-1.5 rounded-full ${
                        running ? 'bg-(--amber) animate-pulse shadow-[0_0_8px_rgba(239,159,39,0.6)]' : 
                ...
                <button
                    onClick={onRun}
                    disabled={running}
                    className={`group relative overflow-hidden rounded-[4px] p-[8px_24px] font-mono text-[11px] font-bold uppercase cursor-pointer tracking-[0.15em] transition-all border shadow-lg disabled:cursor-not-allowed disabled:opacity-60 ${
                        phase === 'passed' 
