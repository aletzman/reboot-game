...
export function PseudocodeSummary({ blocks, depth = 0 }: { blocks: LogicAssemblyBlock[]; depth?: number }) {
    return (
        <div className="font-mono text-[11px] text-(--text-ghost) leading-relaxed p-2 max-h-[180px] overflow-y-auto custom-scrollbar">
                ...
                return (
                    <div key={block.id} className="flex gap-3 group/line">
                        ...
                        <div className="flex-1">
                            ...
                            >
                                {'  '.repeat(depth)}
                                <span className="font-bold opacity-50 select-none mr-1">»</span>
